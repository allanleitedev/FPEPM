            ...
            <div className="text-center mb-12">
              ...
              <div className="space-y-6 animate-in slide-in-from-bottom duration-1000 delay-300">
                ...
                <div className="flex flex-col gap-4 px-4">
                  <Button size="lg" className="bg-pentathlon-green hover:bg-pentathlon-green-dark text-white transform hover:scale-105 transition-all duration-200 shadow-lg hover:shadow-xl">
                  ...
                  <Button size="lg" variant="outline" className="border-pentathlon-blue text-pentathlon-blue hover:bg-pentathlon-blue hover:text-white transform hover:scale-105 transition-all duration-200 shadow-md hover:shadow-lg">
